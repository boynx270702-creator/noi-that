      ...
      <div className="absolute inset-0 pointer-events-none z-[50] overflow-hidden opacity-90 transition-opacity duration-700">
        ...
        >
          <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
            ...
            <g style={{ transform: `translate(${mouseX * -10}px, ${mouseY * -10}px)` }}>
              <g opacity="0.4" stroke="#27d6ff" strokeWidth="0.3">
                <line x1="36" y1="36" x2="164" y2="164" />
                <line x1="164" y1="36" x2="36" y2="164" />
              </g>
              <circle cx="100" cy="100" r="55" stroke="#27d6ff" strokeWidth="0.2" opacity="0.3" />
            </g>

            {/* Main Compass Rings - Parallax lớp giữa (0px) */}
            <g style={{ transformOrigin: '100px 100px', animation: 'spin-slow 120s linear infinite' }}>
              <circle cx="100" cy="100" r="80" stroke="#27d6ff" strokeWidth="0.5" strokeDasharray="2 6" />
              <circle cx="100" cy="100" r="90" stroke="#27d6ff" strokeWidth="0.2" opacity="0.5" />
            </g>
            <circle cx="100" cy="100" r="60" stroke="#27d6ff" strokeWidth="0.5" opacity="0.7" />

            {/* Front Crosshairs & Text - Parallax lớp nổi (+15px) */}
            <g style={{ transform: `translate(${mouseX * 15}px, ${mouseY * 15}px)` }}>
              <line x1="100" y1="10" x2="100" y2="190" stroke="#27d6ff" strokeWidth="0.5" opacity="0.6" />
              <line x1="10" y1="100" x2="190" y2="100" stroke="#27d6ff" strokeWidth="0.5" opacity="0.6" />
              <circle cx="100" cy="100" r="2.5" fill="#27d6ff" className="drop-shadow-[0_0_5px_#27d6ff]" style={{ animation: 'pulse-subtle 3s infinite' }} />
              <text x="105" y="45" fill="#27d6ff" fontSize="6" letterSpacing="1" className="font-mono" opacity="0.9" fontWeight="bold">N 45°</text>
              <text x="105" y="160" fill="#27d6ff" fontSize="6" letterSpacing="1" className="font-mono" opacity="0.9" fontWeight="bold">S 45°</text>
              <text x="165" y="95" fill="#27d6ff" fontSize="6" letterSpacing="1" className="font-mono" opacity="0.9" fontWeight="bold">E</text>
              <text x="30" y="95" fill="#27d6ff" fontSize="6" letterSpacing="1" className="font-mono" opacity="0.9" fontWeight="bold">W</text>
            </g>
        ...
        >
          <svg viewBox="0 0 180 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
            <path d="M 20 80 L 20 20 L 160 20" stroke="#27d6ff" strokeWidth="0.5" opacity="0.5" />
            <line x1="50" y1="18" x2="50" y2="22" stroke="#27d6ff" strokeWidth="0.5" />
            <line x1="80" y1="18" x2="80" y2="22" stroke="#27d6ff" strokeWidth="0.5" />
            <line x1="110" y1="18" x2="110" y2="22" stroke="#27d6ff" strokeWidth="0.5" />
            <line x1="140" y1="18" x2="140" y2="22" stroke="#27d6ff" strokeWidth="0.5" />
            <line x1="18" y1="50" x2="22" y2="50" stroke="#27d6ff" strokeWidth="0.5" />
            <text x="15" y="15" fill="#27d6ff" fontSize="8" className="font-mono drop-shadow-[0_0_2px_#27d6ff]" opacity="0.9" fontWeight="bold">+</text>
            <text x="140" y="15" fill="#27d6ff" fontSize="6" letterSpacing="1" className="font-mono font-bold drop-shadow-[0_0_2px_#27d6ff]" opacity="0.8">1:100 SCALE</text>
            <text x="25" y="52" fill="#27d6ff" fontSize="6" letterSpacing="1" className="font-mono font-bold drop-shadow-[0_0_2px_#27d6ff]" opacity="0.8">ELEVATION</text>
            <circle cx="20" cy="20" r="1.5" fill="#27d6ff" className="drop-shadow-[0_0_3px_#27d6ff]" />
            <circle cx="160" cy="20" r="1" fill="#27d6ff" opacity="0.5" />
            <circle cx="20" cy="80" r="1" fill="#27d6ff" opacity="0.5" />
          </svg>
        </div>
        ...
        >
          <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full" preserveAspectRatio="xMinYMax meet">
            ...
            <g stroke="#27d6ff" strokeWidth="0.1" opacity="0.2" style={{ transform: `translate(${mouseX * -15}px, ${mouseY * -15}px)` }}>
            ...
            <g stroke="#27d6ff" style={{ transform: `translate(${mouseX * 12}px, ${mouseY * 12}px)` }}>
              {/* Inner details */}
              ...
              <g fill="#27d6ff" fontSize="9" className="font-mono drop-shadow-[0_0_2px_#27d6ff]" letterSpacing="1">
                ...
                {/* Data Block Top Left */}
                <rect x="50" y="30" width="90" height="40" fill="none" stroke="#27d6ff" strokeWidth="0.4" />
            ...
            <g style={{ transform: `translate(${mouseX * 25}px, ${mouseY * 25}px)` }}>
              ...
              <circle cx="200" cy="200" r="3" fill="#27d6ff" className="drop-shadow-[0_0_8px_#27d6ff]" style={{ animation: 'pulse-subtle 2s infinite' }} />
              <circle cx="220" cy="90" r="2.5" fill="#27d6ff" className="drop-shadow-[0_0_5px_#27d6ff]" />
              <circle cx="320" cy="270" r="2.5" fill="#27d6ff" className="drop-shadow-[0_0_5px_#27d6ff]" />
              <circle cx="100" cy="150" r="2.5" fill="#FFFFFF" className="drop-shadow-[0_0_5px_#FFFFFF]" />
              
              <g fill="#27d6ff" fontSize="9" className="font-mono drop-shadow-[0_0_3px_#27d6ff]" letterSpacing="1">
                ...
                <rect x="270" y="350" width="85" height="45" fill="none" stroke="#27d6ff" strokeWidth="0.4" />
                ...
                <rect x="330" y="160" width="55" height="40" fill="none" stroke="#27d6ff" strokeWidth="0.4" />
                ...
                <line x1="330" y1="180" x2="320" y2="270" strokeWidth="0.3" strokeDasharray="1 3" stroke="#27d6ff" />
              </g>
            </g>
