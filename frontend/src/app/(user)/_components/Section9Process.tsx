...
export default function Section9Process() {
  return (
    <section id="Process" className="relative py-32 bg-[#F8F6F2] dark:bg-[#0a0a0a] overflow-hidden">
              ...
              >
                <div className={`flex flex-col md:flex-row items-start md:items-center w-full ${isEven ? 'md:flex-row-reverse' : ''}`}>
                  ...
                  <div className="w-full md:w-1/2 pl-16 md:pl-0 md:pr-16 md:text-right flex flex-col justify-center pt-2 md:pt-0">
                    <div className={`card dark:bg-[#131313] p-6 md:p-8 border border-[#ECE7DE] dark:border-white/5 hover:border-[#C7A25C]/50 transition-colors group relative rounded-[8px] shadow-sm ${isEven ? 'md:ml-16 md:text-left' : ''}`}>
