  ...
  return (
    <section className="py-24 bg-transparent dark:bg-transparent modern-section relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[60%] h-[60%] rounded-full bg-[#1bbce0]/5 blur-[150px]" />
      ...
      <div className="max-w-[1920px] mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="flex-1 md:mr-8">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-[2px] bg-gradient-to-r from-[#1bbce0]/20 to-transparent border-l-2 border-[#1bbce0] text-[#A67C00] dark:text-[#FFD700] text-[11px] font-bold uppercase tracking-widest mb-4 luxury-glow">
              <span className="w-2 h-2 rounded-[2px] bg-[#1bbce0] animate-pulse"></span>
              Sản phẩm nổi bật
            </div>
            <h2 className="w-full uppercase font-heading text-4xl md:text-5xl font-bold text-[#1F1F1F] text-white leading-tight mb-4">
              Không gian sống{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1bbce0] to-[#E5C98A]">đẳng cấp vượt thời gian</span>
            </h2>
            <p className="text-[#1F1F1F]/60 text-white/60 text-base md:text-lg max-w-3xl">
          ...
          <Link href="/san-pham?filter=noi-bat"
            className="group hidden md:flex items-center gap-2 text-sm font-semibold text-[#1F1F1F] text-white hover:text-[#1bbce0] uppercase tracking-widest transition-colors"
          >
              ...
              <div key={product.id} className="flex-[0_0_85%] sm:flex-[0_0_45%] lg:flex-[0_0_28%] xl:flex-[0_0_24%] pl-6">
                <Link href={`/san-pham/${product.id}`} className="group block relative w-full overflow-hidden rounded-[2px] bg-gray-100 dark:bg-[#131313] luxury-glow">
                  ...
                  <div className="relative w-full aspect-[3/4] overflow-hidden">
                    ...
                    {/* Category Tag */}
                    <div className="absolute top-4 left-4 bg-black/80 backdrop-blur-md text-[#27d6ff] px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest rounded-[2px] luxury-glow z-20">
                      {product.category}
                    </div>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-4 group-hover:translate-y-0 transition-transform duration-500 z-20">
                      <div className="w-8 h-[2px] bg-[#1bbce0] mb-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100" />
                      ...
                      <div className="mt-4 pt-4 border-t border-white/20 relative z-20">
                        <span 
                          ...
                          className="flex items-center justify-center gap-2 w-full bg-white/10 backdrop-blur-sm border border-[#27d6ff]/50 text-[#27d6ff] font-bold uppercase tracking-wider text-[11px] py-3 rounded-[2px] hover:bg-[#27d6ff] hover:text-white transition-all duration-300"
                        >
                          Nhận báo giá
        ...
        <div className="mt-8 flex justify-center md:hidden">
          <Link
            ...
            className="group flex items-center gap-2 text-sm font-semibold text-[#1F1F1F] text-white hover:text-[#1bbce0] uppercase tracking-widest transition-colors"
          >
            Xem tất cả
