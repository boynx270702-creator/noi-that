...
export default function ClientToaster() {
  ...
  return (
    <Toaster 
      ...
      toastOptions={{
        className: 'font-sans rounded-[4px] border border-[#ce9e51]/30 bg-white dark:bg-[#111] text-white shadow-[0_4px_30px_rgba(0,0,0,0.1)] !z-[999999]',
        style: { padding: '16px 20px', fontSize: '15px' },
        classNames: {
          success: 'border-[#ce9e51] bg-[#faf8f5] bg-[#020b0d] text-[#b88c45] dark:text-[#ce9e51]',
