    ...
    <div className="pt-[120px] pb-20 bg-[#F9F8F6] dark:bg-[#0a0a0a] min-h-screen text-gray-900 dark:text-white transition-colors duration-300">
      <div className="container mx-auto px-6 max-w-[1200px]">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-['Montserrat',_sans-serif] font-bold mb-6">Tất cả sản phẩm</h1>
        ...
        <div className="flex justify-center">
          <Link href="/" className="bg-[#D3AE3E] text-white px-8 py-3 rounded hover:bg-[#b59332] transition-colors">
            Quay về trang chủ
          </Link>
        </div>
      </div>
