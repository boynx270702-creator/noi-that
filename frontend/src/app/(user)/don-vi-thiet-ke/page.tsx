  ...
  return (
    <div className="bg-[#F8F6F2] dark:bg-[#131313] min-h-screen pt-[120px] pb-20">
      <div className="container mx-auto px-6 max-w-[1200px]">
        ...
        {/* Filters Scaffold */}
        <div id="phan-khuc" className="card dark:bg-[#1c1c1c] shadow-sm dark:shadow-none p-6 rounded-[8px] mb-12 border border-[#ECE7DE] dark:border-white/10 flex flex-wrap gap-4 items-end">
          <CustomSelect 
            label="Phân khúc" 
            value={segment} 
            onChange={setSegment} 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {isLoading ? (
            ...
            <div className="col-span-1 md:col-span-2 lg:col-span-3 card dark:bg-[#1c1c1c] shadow-sm dark:shadow-none border border-[#ECE7DE] dark:border-white/5 rounded-[8px] p-16 text-center flex flex-col items-center justify-center min-h-[400px]">
