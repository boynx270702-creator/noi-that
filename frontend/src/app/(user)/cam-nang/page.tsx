    ...
    <div className="relative pt-[120px] pb-20 bg-transparent min-h-screen text-white">
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-[1400px]">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-white/70 text-lg max-w-2xl mx-auto">Kiến thức chuyên sâu, mẹo hay và xu hướng mới nhất để kiến tạo không gian sống hoàn hảo.</p>
        </div>
        ...
        {heroArticle && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 mb-16">
            {/* Main Hero */}
            <div className="lg:col-span-8 group relative overflow-hidden rounded-[2px] bg-white/5 h-[400px] lg:h-[500px]">
            ...
            {subHeroArticles.length > 0 && (
              <div className="lg:col-span-4 flex flex-col gap-4">
                {subHeroArticles.map((article, idx) => (
                  <div key={idx} className="group flex-1 relative overflow-hidden rounded-[2px] bg-white/5 min-h-[150px]">
