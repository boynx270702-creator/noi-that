            ...
            <div className="space-y-6">
              <div className="bg-[#020b0d]/40 backdrop-blur-md p-6 rounded-[4px] border border-[#27d6ff]/15 shadow-sm flex gap-4 transition-all hover:border-[#27d6ff]/50 hover:-translate-y-1">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/60">Nguồn khách hàng được sàng lọc kỹ lưỡng, có nhu cầu thực tế và ngân sách rõ ràng.</p>
                </div>
              </div>
              ...
              <div className="bg-[#020b0d]/40 backdrop-blur-md p-6 rounded-[4px] border border-[#27d6ff]/15 shadow-sm flex gap-4 transition-all hover:border-[#27d6ff]/50 hover:-translate-y-1">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/60">Gia tăng niềm tin với khách hàng thông qua bộ tiêu chuẩn đánh giá đối tác độc lập của hệ sinh thái.</p>
                </div>
              </div>
              ...
              <div className="bg-[#020b0d]/40 backdrop-blur-md p-6 rounded-[4px] border border-[#27d6ff]/15 shadow-sm flex gap-4 transition-all hover:border-[#27d6ff]/50 hover:-translate-y-1">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/60">Được hỗ trợ quy trình tư vấn, hợp đồng và nghiệm thu chuyên nghiệp, giảm thiểu rủi ro tranh chấp.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#020b0d]/40 backdrop-blur-md p-8 lg:p-10 rounded-[4px] border border-[#27d6ff]/15">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="pt-4">
                  ...
                  <p className="text-white/50 text-xs text-center mt-4">Bằng việc gửi thông tin, bạn đồng ý với các chính sách và quy định của hệ sinh thái.</p>
                </div>
              </form>
            </div>
          </div>
