        ...
        {isFiltersExpanded && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 bg-gray-50/50 dark:bg-[#1a1b23] border border-gray-200 dark:border-gray-800 rounded-[8px] animate-in slide-in-from-top-2 duration-200">
            <div className="flex flex-col gap-1.5 relative">
              ...
              <button onClick={() => setOpenLocationPopover(!openLocationPopover)} className="flex items-center justify-between w-full h-9 px-3 bg-white dark:bg-[#14151a] border border-gray-200 dark:border-gray-800 rounded-[8px] text-sm text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-[#262930] dark:bg-[#1a1b23]">
        ...
        <div className="flex flex-wrap items-center gap-2 mt-1">
          ...
          {locationFilter.length > 0 && (
            <div className="flex items-center gap-1.5 pl-2.5 pr-1 py-1 bg-[#5865f2]/10 text-[#5865f2] border border-[#5865f2]/20 rounded-[8px] text-sm font-medium">
              ...
              <button onClick={() => setLocationFilter([])} className="p-0.5 hover:bg-[#5865f2]/20 rounded-[8px] transition-colors ml-1"><X className="w-3.5 h-3.5" /></button>
            </div>
          )}
          {hasActiveFilter && (
            <button onClick={() => { setLocationFilter([]); setPage(0); }} className="flex items-center gap-1.5 px-2.5 py-1 rounded-[8px] border border-red-500 text-xs font-medium text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors ml-2"><RotateCcw strokeWidth={2} className="w-3.5 h-3.5" /> Đặt lại</button>
          )}
        </div>
      </div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="p-3.5 rounded-[8px] border border-blue-100 dark:border-blue-500/20 bg-blue-50/50 dark:bg-blue-500/10">
                <div className="flex items-center gap-2 mb-1.5">
                  <div className="w-2 h-2 bg-blue-500 rounded-[8px]"></div><span className="text-xs font-medium text-gray-700 dark:text-gray-300">Tổng Khách hàng</span>
                </div>
              ...
              <div className="p-3.5 rounded-[8px] border border-emerald-100 dark:border-emerald-900/30 bg-emerald-50/50 dark:bg-emerald-500/10">
                <div className="flex items-center gap-2 mb-1.5">
                  <div className="w-2 h-2 bg-emerald-50 dark:bg-emerald-500/100 rounded-[8px]"></div><span className="text-xs font-medium text-gray-700 dark:text-gray-300">Tổng Yêu cầu</span>
                </div>
              ...
              {currentData.length === 0 ? (
                ...
                currentData.map((customer, index) => (
                  <tr key={customer.id} className="border-b border-gray-200 dark:border-gray-800 hover:bg-gray-50/50 dark:hover:bg-[#262930] dark:bg-[#1a1b23] transition-colors group animate-in fade-in slide-in-from-bottom-4 duration-500" style={{ animationDelay: `${index * 50}ms`, animationFillMode: 'both' }}>
                    ...
                    <td className="px-5 py-3.5 border-l border-gray-200 dark:border-gray-800">
                      <span className="inline-flex items-center px-2 py-0.5 rounded-[8px] text-xs font-medium bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-800">{customer.totalLeads} yêu cầu</span>
                    </td>
                    <td className="px-5 py-3.5 border-l border-gray-200 dark:border-gray-800">
        ...
        <div className="fixed inset-0 z-[100] flex justify-end">
          ...
          <div className="relative bg-white dark:bg-[#14151a] w-full max-w-2xl h-full flex flex-col border-l border-gray-200 dark:border-gray-800 animate-in slide-in-from-right duration-300 shadow-none z-10">
                  ...
                  <div className="grid grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input type="text" required value={formData.fullName} onChange={e => {setFormData({...formData, fullName: e.target.value}); if (errors.fullName) setErrors({...errors, fullName: ''});}} className={`pl-9 w-full bg-gray-50/50 dark:bg-[#1a1b23] border ${errors.fullName ? 'border-red-500 focus:ring-red-500/20' : 'border-gray-200 dark:border-gray-700 focus:ring-[#5865f2]/20'} text-sm h-10 rounded-[8px] text-gray-900 dark:text-white transition-all hover:bg-white dark:bg-[#14151a] dark:hover:bg-[#1a1b23] focus:outline-none focus:ring-[3px] focus:border-[#5865f2]/40`} placeholder="VD: Nguyễn Văn A..." />
                      </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input type="text" required value={formData.phoneNumber} onChange={e => {setFormData({...formData, phoneNumber: e.target.value}); if (errors.phoneNumber) setErrors({...errors, phoneNumber: ''});}} className={`pl-9 w-full bg-gray-50/50 dark:bg-[#1a1b23] border ${errors.phoneNumber ? 'border-red-500 focus:ring-red-500/20' : 'border-gray-200 dark:border-gray-700 focus:ring-[#5865f2]/20'} text-sm h-10 rounded-[8px] text-gray-900 dark:text-white transition-all hover:bg-white dark:bg-[#14151a] dark:hover:bg-[#1a1b23] focus:outline-none focus:ring-[3px] focus:border-[#5865f2]/40`} placeholder="0901..." />
                      </div>
                  ...
                  <div className="grid grid-cols-2 gap-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input type="text" value={formData.address} onChange={e => setFormData({...formData, address: e.target.value})} className="pl-9 w-full bg-gray-50/50 dark:bg-[#1a1b23] border border-gray-200 dark:border-gray-700 text-sm h-10 rounded-[8px] text-gray-900 dark:text-white transition-all hover:bg-white dark:bg-[#14151a] dark:hover:bg-[#1a1b23] focus:outline-none focus:ring-[3px] focus:ring-[#5865f2]/20 focus:border-[#5865f2]/40" placeholder="Hà Nội..." />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input type="number" value={formData.totalLeads} onChange={e => setFormData({...formData, totalLeads: parseInt(e.target.value) || 0})} className="pl-9 w-full bg-gray-50/50 dark:bg-[#1a1b23] border border-gray-200 dark:border-gray-700 text-sm h-10 rounded-[8px] text-gray-900 dark:text-white transition-all hover:bg-white dark:bg-[#14151a] dark:hover:bg-[#1a1b23] focus:outline-none focus:ring-[3px] focus:ring-[#5865f2]/20 focus:border-[#5865f2]/40" />
                    </div>
                  </div>
            ...
            <div className="h-20 flex items-center justify-end gap-3 px-6 border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-[#14151a] shrink-0">
              ...
              <button type="submit" form="customer-form" className="flex items-center gap-2 bg-[#5865f2] hover:bg-[#4752c4] text-white rounded-[8px] font-medium text-sm h-10 px-6 border-0 cursor-pointer transition-colors">
