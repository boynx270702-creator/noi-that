        ...
        <div className={`p-4 ${isSummaryCollapsed ? 'pb-4' : 'sm:p-5 sm:pb-5'}`}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <h3 className="font-heading font-medium text-gray-900 dark:text-white text-sm">Tổng Quan Đánh Giá</h3>
            ...
            <div className="mt-4 grid grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="p-3.5 rounded-[8px] border border-blue-100 dark:border-blue-500/20 bg-blue-50/50 dark:bg-blue-500/10">
                <div className="flex items-center gap-2 mb-1.5">
                  <div className="w-2 h-2 bg-blue-500 rounded-[8px]"></div><span className="text-xs font-medium text-gray-700 dark:text-gray-300">Tổng review</span>
                </div>
              ...
              <div className="p-3.5 rounded-[8px] border border-emerald-100 dark:border-emerald-900/30 bg-emerald-50/50 dark:bg-emerald-500/10">
                <div className="flex items-center gap-2 mb-1.5">
                  <div className="w-2 h-2 bg-emerald-50 dark:bg-emerald-500/100 rounded-[8px]"></div><span className="text-xs font-medium text-gray-700 dark:text-gray-300">Hiển thị</span>
                </div>
              ...
              <div className="p-3.5 rounded-[8px] border border-amber-100 dark:border-amber-900/30 bg-amber-50/50 dark:bg-amber-500/10">
                <div className="flex items-center gap-2 mb-1.5">
                  <div className="w-2 h-2 bg-amber-50 dark:bg-amber-500/100 rounded-[8px]"></div><span className="text-xs font-medium text-gray-700 dark:text-gray-300">Nổi bật</span>
                </div>
                ...
                <tr>
                  <td colSpan={4} className="px-5 py-16 text-center animate-in fade-in zoom-in-95 duration-500">
                    <div className="flex flex-col items-center justify-center text-gray-500 dark:text-gray-400">
                      ...
                      <h3 className="font-heading text-lg font-medium text-gray-900 dark:text-white mb-2">Không tìm thấy review</h3>
                    </div>
                  </td>
                </tr>
              ) : (
                  ...
                  <tr key={item.id} className="border-b border-gray-200 dark:border-gray-800 hover:bg-gray-50/50 dark:hover:bg-[#262930] dark:bg-[#1a1b23] transition-colors group animate-in fade-in slide-in-from-bottom-4 duration-500" style={{ animationDelay: `${index * 50}ms`, animationFillMode: 'both' }}>
                      ...
                      <div className="flex items-center gap-3">
                        <div 
                          className={`w-4 h-4 rounded-[8px] border flex items-center justify-center cursor-pointer transition-colors shrink-0 ${
                            selectedIds.includes(item.id.toString()) ? 'bg-[#5865f2] border-[#5865f2]' : 'border-gray-300'
                          }`}
                    ...
                    <td className="px-5 py-3.5 border-l border-gray-200 dark:border-gray-800">
                      <div className="flex flex-col gap-2 items-start">
                        <span className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-[8px] text-xs font-medium ${
                          item.status === 'VISIBLE' 
                        ...
                        {item.featured && (
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-[8px] text-xs font-medium bg-amber-50 dark:bg-amber-500/10 text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-500/20">
        ...
        <div className="fixed inset-0 z-[100] flex justify-end">
          ...
          <div className="relative bg-white dark:bg-[#14151a] w-full max-w-2xl h-full flex flex-col border-l border-gray-200 dark:border-gray-800 animate-in slide-in-from-right duration-300 shadow-none z-10">
              ...
              <form id="testimonial-form" onSubmit={handleSave} className="p-6 space-y-8">
                  ...
                  <div className="grid grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input type="text" value={formData.customerName} onChange={e => {setFormData({...formData, customerName: e.target.value}); if (errors.customerName) setErrors({...errors, customerName: ''});}} className={`pl-9 w-full bg-gray-50/50 dark:bg-[#1a1b23] border ${errors.customerName ? 'border-red-500 focus:ring-red-500/20' : 'border-gray-200 dark:border-gray-700 focus:ring-[#5865f2]/20'} text-sm h-10 rounded-[8px] text-gray-900 dark:text-white transition-all hover:bg-white dark:bg-[#14151a] dark:hover:bg-[#1a1b23] focus:outline-none focus:ring-[3px] focus:border-[#5865f2]/40`} placeholder="Nguyễn Văn A..." />
                      </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input type="text" value={formData.project} onChange={e => {setFormData({...formData, project: e.target.value}); if (errors.project) setErrors({...errors, project: ''});}} placeholder="VD: Chung cư Vinhome Smart City..." className={`pl-9 w-full bg-gray-50/50 dark:bg-[#1a1b23] border ${errors.project ? 'border-red-500 focus:ring-red-500/20' : 'border-gray-200 dark:border-gray-700 focus:ring-[#5865f2]/20'} text-sm h-10 rounded-[8px] text-gray-900 dark:text-white transition-all hover:bg-white dark:bg-[#14151a] dark:hover:bg-[#1a1b23] focus:outline-none focus:ring-[3px] focus:border-[#5865f2]/40`} />
                      </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea rows={4} value={formData.content} onChange={e => {setFormData({...formData, content: e.target.value}); if (errors.content) setErrors({...errors, content: ''});}} className={`w-full bg-gray-50/50 dark:bg-[#1a1b23] border ${errors.content ? 'border-red-500 focus:ring-red-500/20' : 'border-gray-200 dark:border-gray-700 focus:ring-[#5865f2]/20'} text-sm rounded-[8px] text-gray-900 dark:text-white p-3 transition-all hover:bg-white dark:bg-[#14151a] dark:hover:bg-[#1a1b23] focus:outline-none focus:ring-[3px] focus:border-[#5865f2]/40 resize-none`} placeholder="Nội dung review của khách hàng..." />
                  ...
                  <div className="grid grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input type="number" min="1" max="5" value={formData.rating} onChange={e => setFormData({...formData, rating: parseInt(e.target.value) || 5})} className="pl-9 w-full bg-gray-50/50 dark:bg-[#1a1b23] border border-gray-200 dark:border-gray-700 text-sm h-10 rounded-[8px] text-gray-900 dark:text-white transition-all hover:bg-white dark:bg-[#14151a] dark:hover:bg-[#1a1b23] focus:outline-none focus:ring-[3px] focus:ring-[#5865f2]/20 focus:border-[#5865f2]/40" />
                      </div>
                    </div>
                  ...
                  <div className="pt-1">
                    <label className="flex items-center gap-3 p-3 border border-gray-200 dark:border-gray-700 rounded-[8px] cursor-pointer hover:bg-gray-50 dark:hover:bg-[#262930] dark:bg-[#1a1b23] dark:hover:bg-[#1a1b23] transition-colors">
                      <input type="checkbox" checked={formData.featured} onChange={e => setFormData({...formData, featured: e.target.checked})} className="w-4 h-4 rounded-[8px] border-gray-300 accent-amber-500" />
            ...
            <div className="h-20 flex items-center justify-end gap-3 px-6 border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-[#14151a] shrink-0">
              ...
              <button type="submit" form="testimonial-form" className="flex items-center gap-2 bg-[#5865f2] hover:bg-[#4752c4] text-white rounded-[8px] font-medium text-sm h-10 px-6 border-0 cursor-pointer transition-colors">
